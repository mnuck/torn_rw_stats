...
This file provides guidance to AI coding agents (Claude Code, Codex, and others) when working with code in this repository. It is the canonical agent instructions file; harness-specific files like CLAUDE.md simply include it.
