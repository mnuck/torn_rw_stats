...
func (c *Client) EnsureWarSheets(ctx context.Context, spreadsheetID string, war *domain.War) (*domain.SheetConfig, error) {
...
func (c *Client) UpdateWarSummary(ctx context.Context, spreadsheetID string, config *domain.SheetConfig, summary *domain.WarSummary) error {
	manager := NewWarSheetsManager(c)
...
func (c *Client) UpdateAttackRecords(ctx context.Context, spreadsheetID string, config *domain.SheetConfig, records []domain.AttackRecord) error {
	processor := NewAttackRecordsProcessor(c)
...
func (c *Client) UpdateStatusV2(ctx context.Context, spreadsheetID, sheetName string, records []domain.StatusV2Record) error {
	manager := NewStatusV2Manager(c)
